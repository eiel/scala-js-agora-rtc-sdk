...
trait Client extends js.Object {
  ...
  def publish(stream: Stream, onFailure: OnFailure): Unit = js.native
  ...
  /**
    ...
    */
  def setRemoteVideoStreamType(stream: Stream, streamType: Short): Unit = js.native

  /**
    * @see https://docs.agora.io/en/Voice/API%20Reference/web/v2.6.1/interfaces/agorartc.client.html#setremotevideostreamtype
    */
  def setStreamFallbackOption(stream: Stream, fallbackType: Short): Unit = js.native
  ...
  def subscribe(stream: Stream, options: SubscribeOptions): Unit = js.native
  ...
  def unpublish(stream: Stream, onFailure: OnFailure): Unit = js.native
  ...
  def unsubscribe(stream: Stream, onFailure: OnFailure): Unit = js.native
